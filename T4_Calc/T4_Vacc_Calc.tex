...
\subsubsection{Term \eqref{post_vac4.1}}
...
\subsubsection{Term \eqref{post_vac4.2}}
...
\frac{\slashed{p}_3+m}{2m^2} 
 ...
 \slashed{g}(p_{4}-p_{1})\right)
.\end{align*}
\subsubsection{Term \eqref{post_vac4.3}}
In analogy to \eqref{post_vac4.1} we find
\begin{align*}
...
\frac{\slashed{p}_3+m}{2m^2} 
 ...
 \slashed{g}(p_{4}-p_{1})\right)
.\end{align*}
\subsubsection{Term \eqref{post_vac4.4}}
In analogy to \eqref{post_vac4.1} we find
\begin{align*}
...
\subsection{Term \eqref{post_vac5}}
...
\subsubsection{Term \eqref{post_vac5.1}}
...
\subsubsection{Term \eqref{post_vac5.2}}
In analogy to term \eqref{post_vac4.1} we find
\begin{align*}
...
\subsubsection{Term \eqref{post_vac6}}
