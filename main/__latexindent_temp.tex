...
Subsec.\ \ref{sec:discussion} contains a discussion and an outlook on 
future research.
...
\todo{merge with Dirac
 conclusion and possibly further global points}
...
that the Green's functions in \eqref{eq:KGtwopartint} are replaced 
...
in \eqref{eq:KGtwopartint}. Moreover, as the previous work 
...
of Eq.\@ \eqref{eq:KGtwopartint} would have to answer.
