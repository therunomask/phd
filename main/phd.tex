...
\begin{align}
\forall k \in \mathbb{N}: [k]&:=\{l\in\mathbb{N}\mid l\le k\}\\
...
\| \partial_{u'}a\|_{\mathrm{op},\infty} \sup_{p\subseteq u} 
\|\partial_p \Delta^{n-1}_{\odd}(\cdot,t_0)\|_{I_2,\gamma}\\
&+\frac{2^{|u|+1}}{\gamma} \sup_{u'\subseteq u} 
\|  \partial_{u'}b\|_{I_2,\infty}\sup_{p\subseteq u}
...
\begin{align}
 ...
 \sup_{p\subseteq u} \sum_{w\subseteq p} 
 \int_{t_0}^{t}dt' e^{\gamma t'}
 \| \partial_{p\backslash w}a \|_{\mathrm{op},\infty}
 \|\partial_w \Delta^{n-1}(\cdot,t_0)\|_{\mathrm{op},\gamma}\\
 &+ \sup_{t\in[t_0,t_1]} e^{-\gamma t}
 \sup_{p\subseteq u}\sum_{w\subseteq p} 
 \int_{t_0}^{t}dt'  e^{\gamma t}
 \|  \partial_{u\backslash p}b\|_{\mathrm{op},\infty}
\|\partial_w \Delta^{n-2}(\cdot,t_0) \|_{\mathrm{op},\gamma}\\
&\le
...
&+ \frac{1}{\gamma}
\sup_{p\subseteq u} \sum_{w\subseteq p} 
\|  \partial_{p\backslash w}b\|_{\mathrm{op},\infty}
\|\partial_w \Delta^{n-2}(\cdot,t_0) \|_{\mathrm{op},\gamma}\\
&\le
\frac{2^{|u|}}{\gamma}
\sup_{u'\subseteq u}\| \partial_{u'}a \|_{\mathrm{op},\infty}
 \sup_{w\subseteq u} 
\|\partial_w \Delta^{n-1}(\cdot,t_0)\|_{\mathrm{op},\gamma}\\
&+ \frac{2^{|u|}}{\gamma}
\sup_{u'\subseteq u}\| \partial_{u'}b \|_{\mathrm{op},\infty}
\sup_{w\subseteq u}
\|\partial_w \Delta^{n-2}(\cdot,t_0) \|_{\mathrm{op},\gamma}
\end{align}
...
\left\{\|\partial_{u'}a\|_{\mathrm{op},\infty},
\|\partial_{u'}a\|_{\mathrm{op},\infty},
\|\partial_{u'}b\|_{I_2,\infty},
\|\partial_{u'}b\|_{\mathrm{op},\infty}  \right\},
\end{equation}
...
that \(\partial_u R^B_m\) for any 
finite set \(u\subset \mathbb{N}\) is a 
