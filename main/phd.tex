...
while \(\psi^{\free}\) and \(\mathscr{S}^{\ret}_k\) refer to 
a solution and the 
retarded Greens function of the free Dirac equation, respectively.
Equations like 
...
\((x_1-x_2)^2=0\) and has a correct 
non-relativistic limit\cite[section 3.6]{direct_interaction_quantum} is given by
\begin{equation}
	K(x_1,x_2) = i\, \frac{e_1e_2}{4\pi} \gamma_1^\mu \gamma_{2,\mu} \; \delta((x_1-x_2)^2),
	\label{eq:twopartkernel1/2}
\end{equation}
for the spin-1/2 case and
\begin{equation}
