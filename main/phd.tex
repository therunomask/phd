...
We can use the \(R\) to revert this motion. By if the chosen 
polarisations \(V,V'\) belong to the apropriate polarisation 
classes \(V\in C_\Sigma(A), V'\in C_{\Sigma'}(A)\) 
condition a) of 
theorem \ref{thm: L R shale Stinespring} is fulfilled 
