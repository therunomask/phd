...
wechselwirken. In dieser Arbeit werden zunächst bereits bestehende Resultate über 
...
Zeitentwicklungsoperatoren eindeutig, bis auf eine 
Phase welche vom externen Feld abhängen kann.
In dieser Arbeit wird das Problem diese Phase 
zu bestimmen teilweise durch eine geometrische 
Konstruktion dieser Phase behoben.
Kausalität spielt bei dieser Konstruktion eine Rolle.

Anschließend wird eine einfache Formel für den Streuoperator 
...
Quantenfeldtheorie mit der in der Quantenfeldtheorie auf 
