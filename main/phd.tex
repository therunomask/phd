...
\begin{equation}\tag{\ref{dirac free}}
  0= (i\slashed{\partial}-m \id) \psi,
\end{equation}
to a fixed finite number of particles, he sought to apply 
...
the structure of \(\Omega\) is implicitly used also in the standard 
...
\begin{equation}\label{dirac}
  0= (i\slashed{\partial}-e\slashed{A}-m \id) \psi.
\end{equation}
...
\(\varphi_1\in\mathcal{H}^-\). Whenever the wavefunctions 
...
\emph{lift} \(\tilde{U}^A\) to objects like the 
