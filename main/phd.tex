...
\begin{equation}\label{sleek_second_quantised_scattering_operator}
...
\begin{multline}
j_A(F)=i \partial_{\varepsilon} \left. \sum_{n\in\mathbb{N}} \frac{C_n}{n!}(A+\varepsilon F) \right|_{\varepsilon=0}\\
...
\end{multline}
At this point we use lemma \ref{nested_kommuted_G}. This results in 
\begin{multline}\label{sleek_current_calc3}
i\langle \Omega,\partial_{\varepsilon}\left.  e^{-G(\ln (U^A))} 
e^{G(\ln (U^{A+\varepsilon F}))} \Omega\rangle \right|_{\varepsilon=0}\\
 =i   \sum_{k=1}^\infty \frac{(-1)^k}{(k+1)!}  \partial_{\varepsilon}\langle \Omega,
 \tr\left(P_- \ln U^A P_+[\ln U^A ,\ln U^{A+\varepsilon F} ]_{k-1}\right) \\
 - \tr\left(P_+ \ln U^A P_-[\ln U^A,\ln U^{A+\varepsilon F} ]_{k-1}\right)\\
+\left.G\left([\ln U^A,\ln U^{A+\varepsilon F} ]_m\right) \Omega \rangle\right|_{\varepsilon=0}\\
=i   \sum_{k=1}^\infty \frac{(-1)^k}{(k+1)!}  \partial_{\varepsilon}\langle \Omega,
 \tr\left(P_- \ln U^A P_+[\ln U^A ,\ln U^{A+\varepsilon F} ]_{k-1}\right) \\
 - \left. \tr\left(P_+ \ln U^A P_-[\ln U^A,\ln U^{A+\varepsilon F} ]_{k-1}\right)  \Omega \rangle\right|_{\varepsilon=0}\\
=i  \partial_{\varepsilon} \left.\sum_{k=1}^\infty \frac{(-1)^k}{(k+1)!} 
 \tr\left(P_- \ln U^A P_+[\ln U^A ,\ln U^{A+\varepsilon F} ]_{k-1}\right) \right|_{\varepsilon=0}\\
 -i  \partial_{\varepsilon} \left.\sum_{k=1}^\infty \frac{(-1)^k}{(k+1)!}  \tr\left(P_+ \ln U^A P_-[\ln U^A,\ln U^{A+\varepsilon F} ]_{k-1}\right) \right|_{\varepsilon=0}\\
